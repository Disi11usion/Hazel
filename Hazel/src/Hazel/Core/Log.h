...
public:
  ...
  static void CoreLog(LogClassify classify, const Event &event) {
    std::stringstream stringstream;
    stringstream << event;
    switch (classify) {
    case LogClassify::INFO:
      core_logger_s_->info(stringstream.str());
      break;
    case LogClassify::ERROR:
      core_logger_s_->error(stringstream.str());
    case LogClassify::WARN:
      core_logger_s_->warn(stringstream.str());
      break;
    case LogClassify::TRACE:
      core_logger_s_->trace(stringstream.str());
      break;
    }
  };
  template <runtime_fmtable T, typename... Args>
  ...
  static void AppLog(LogClassify classify, const Event &event) {
    std::stringstream stringstream;
    stringstream << event;
    switch (classify) {
    case LogClassify::INFO:
      client_logger_s_->info(stringstream.str());
      break;
    case LogClassify::ERROR:
      client_logger_s_->error(stringstream.str());
    case LogClassify::WARN:
      client_logger_s_->warn(stringstream.str());
      break;
    case LogClassify::TRACE:
      client_logger_s_->trace(stringstream.str());
      break;
    }
  };
